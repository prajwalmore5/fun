...
driver.find_element_by_css_selector('#page-container > div > div.signin-wrapper > form > fieldset > div:nth-child(2) > input').send_keys('youonlyliveonce1998yolo@gmail.com')
#driver.find_element_by_name('js-username-field email-input js-initial-focus').send_keys('youonlyliveonce1998yolo@gmail.com')

driver.find_element_by_css_selector('#page-container > div > div.signin-wrapper > form > fieldset > div:nth-child(3) > input').send_keys('youonlyliveonce')
